# Meta-analysis of Trial-Based Health Economic Evaluations: A Tutorial with Open-Source R Code

In this tutorial, you will perform a meta-analysis of trial-based health economic evaluations using the incremental net benefit framework. The repository contains the R scripts and example Excel files needed to standardise costs across countries and price years, prepare variances, and perform the meta-analyses described in the publication. [Insert reference and DOI once published] 
